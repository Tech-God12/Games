// post/SSAOShader - GLSL Shader Library
export const SSAOShaderShader = `
...
`;
export const SSAOShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
