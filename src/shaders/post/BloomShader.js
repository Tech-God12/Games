// post/BloomShader - GLSL Shader Library
export const BloomShaderShader = `
...
`;
export const BloomShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
