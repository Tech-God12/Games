// post/MotionBlurShader - GLSL Shader Library
export const MotionBlurShaderShader = `
...
`;
export const MotionBlurShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
