// weapons/MuzzleShader - GLSL Shader Library
export const MuzzleShaderShader = `
...
`;
export const MuzzleShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
