// lib/LightingLib - GLSL Shader Library
export const LightingLibShader = `
...
`;
export const LightingLibUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
