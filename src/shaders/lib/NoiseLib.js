// lib/NoiseLib - GLSL Shader Library
export const NoiseLibShader = `
...
`;
export const NoiseLibUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
