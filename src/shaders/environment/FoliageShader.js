// environment/FoliageShader - GLSL Shader Library
export const FoliageShaderShader = `
...
`;
export const FoliageShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
