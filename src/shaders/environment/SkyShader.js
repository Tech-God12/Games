// environment/SkyShader - GLSL Shader Library
export const SkyShaderShader = `
...
`;
export const SkyShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
