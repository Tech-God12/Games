// environment/WaterShader - GLSL Shader Library
export const WaterShaderShader = `
...
`;
export const WaterShaderUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
