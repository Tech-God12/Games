// chunks/ParticleChunk - GLSL Shader Library
export const ParticleChunkShader = `
...
`;
export const ParticleChunkUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
