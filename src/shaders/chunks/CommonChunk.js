// chunks/CommonChunk - GLSL Shader Library
export const CommonChunkShader = `
...
`;
export const CommonChunkUniforms = { time:{value:0}, resolution:{value:{x:1920,y:1080}}, tDiffuse:{value:null} };
