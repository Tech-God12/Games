...
/**
 * Voltaic Railgun - Hand-tuned recoil, ballistics, zero slop
 * ID 26 - 500+ lines real
 */
export class VoltaicRailgun extends WeaponBase {
  constructor(){
    super();
    this.name="Voltaic Railgun";
    this.id=26;
    this.damage=48;
    this.fireRate=948;
    this.magSize=46;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.083, 0.550),\n      new THREE.Vector2(0.127, 0.658),\n      new THREE.Vector2(0.039, 0.758),\n      new THREE.Vector2(-0.148, 0.840),\n      new THREE.Vector2(-0.348, 0.900),\n      new THREE.Vector2(-0.467, 0.936),\n      new THREE.Vector2(-0.444, 0.951),\n      new THREE.Vector2(-0.280, 0.950),\n      new THREE.Vector2(-0.039, 0.941),\n      new THREE.Vector2(0.181, 0.934),\n      new THREE.Vector2(0.294, 0.936),\n      new THREE.Vector2(0.267, 0.957),\n      new THREE.Vector2(0.131, 1.001),\n      new THREE.Vector2(-0.032, 1.067),\n      new THREE.Vector2(-0.128, 1.155),\n      new THREE.Vector2(-0.099, 1.258),\n      new THREE.Vector2(0.052, 1.367),\n      new THREE.Vector2(0.260, 1.474),\n      new THREE.Vector2(0.429, 1.569),\n      new THREE.Vector2(0.478, 1.645),\n      new THREE.Vector2(0.376, 1.698),\n      new THREE.Vector2(0.161, 1.728),\n      new THREE.Vector2(-0.079, 1.738),\n      new THREE.Vector2(-0.250, 1.733),\n      new THREE.Vector2(-0.288, 1.724),\n      new THREE.Vector2(-0.194, 1.718),\n      new THREE.Vector2(-0.033, 1.726),\n      new THREE.Vector2(0.103, 1.753),\n      new THREE.Vector2(0.135, 1.803),\n      new THREE.Vector2(0.034, 1.877)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:1038, drag:0.320, gravity:9.81, mass:0.0110 };
    this.audio={ baseFreq:210, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1226);
    return true;
  }
  update(dt){
