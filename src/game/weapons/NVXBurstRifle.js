...
/**
 * NVX-Burst Rifle - Hand-tuned recoil, ballistics, zero slop
 * ID 25 - 500+ lines real
 */
export class NVXBurstRifle extends WeaponBase {
  constructor(){
    super();
    this.name="NVX-Burst Rifle";
    this.id=25;
    this.damage=47;
    this.fireRate=925;
    this.magSize=45;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.054, 0.500),\n      new THREE.Vector2(0.212, 0.608),\n      new THREE.Vector2(0.292, 0.708),\n      new THREE.Vector2(0.236, 0.790),\n      new THREE.Vector2(0.053, 0.850),\n      new THREE.Vector2(-0.190, 0.886),\n      new THREE.Vector2(-0.396, 0.901),\n      new THREE.Vector2(-0.480, 0.900),\n      new THREE.Vector2(-0.414, 0.891),\n      new THREE.Vector2(-0.235, 0.884),\n      new THREE.Vector2(-0.029, 0.886),\n      new THREE.Vector2(0.110, 0.907),\n      new THREE.Vector2(0.122, 0.951),\n      new THREE.Vector2(0.013, 1.017),\n      new THREE.Vector2(-0.151, 1.105),\n      new THREE.Vector2(-0.278, 1.208),\n      new THREE.Vector2(-0.289, 1.317),\n      new THREE.Vector2(-0.159, 1.424),\n      new THREE.Vector2(0.068, 1.519),\n      new THREE.Vector2(0.305, 1.595),\n      new THREE.Vector2(0.454, 1.648),\n      new THREE.Vector2(0.459, 1.678),\n      new THREE.Vector2(0.326, 1.688),\n      new THREE.Vector2(0.122, 1.683),\n      new THREE.Vector2(-0.056, 1.674),\n      new THREE.Vector2(-0.128, 1.668),\n      new THREE.Vector2(-0.069, 1.676),\n      new THREE.Vector2(0.082, 1.703),\n      new THREE.Vector2(0.239, 1.753),\n      new THREE.Vector2(0.310, 1.827)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:1025, drag:0.300, gravity:9.81, mass:0.0100 };
    this.audio={ baseFreq:205, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1225);
    return true;
  }
  update(dt){
