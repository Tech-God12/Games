...
/**
 * Nova Cannon - Hand-tuned recoil, ballistics, zero slop
 * ID 29 - 500+ lines real
 */
export class NovaCannon extends WeaponBase {
  constructor(){
    super();
    this.name="Nova Cannon";
    this.id=29;
    this.damage=51;
    this.fireRate=417;
    this.magSize=49;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.001, 0.700),\n      new THREE.Vector2(-0.102, 0.808),\n      new THREE.Vector2(-0.076, 0.908),\n      new THREE.Vector2(0.061, 0.990),\n      new THREE.Vector2(0.233, 1.050),\n      new THREE.Vector2(0.347, 1.086),\n      new THREE.Vector2(0.331, 1.101),\n      new THREE.Vector2(0.175, 1.100),\n      new THREE.Vector2(-0.066, 1.091),\n      new THREE.Vector2(-0.299, 1.084),\n      new THREE.Vector2(-0.431, 1.086),\n      new THREE.Vector2(-0.416, 1.107),\n      new THREE.Vector2(-0.274, 1.151),\n      new THREE.Vector2(-0.081, 1.217),\n      new THREE.Vector2(0.068, 1.305),\n      new THREE.Vector2(0.102, 1.408),\n      new THREE.Vector2(0.008, 1.517),\n      new THREE.Vector2(-0.161, 1.624),\n      new THREE.Vector2(-0.315, 1.719),\n      new THREE.Vector2(-0.365, 1.795),\n      new THREE.Vector2(-0.272, 1.848),\n      new THREE.Vector2(-0.060, 1.878),\n      new THREE.Vector2(0.190, 1.888),\n      new THREE.Vector2(0.379, 1.883),\n      new THREE.Vector2(0.436, 1.874),\n      new THREE.Vector2(0.348, 1.868),\n      new THREE.Vector2(0.168, 1.876),\n      new THREE.Vector2(-0.011, 1.903),\n      new THREE.Vector2(-0.101, 1.953),\n      new THREE.Vector2(-0.062, 2.027)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:1077, drag:0.380, gravity:9.81, mass:0.0140 };
    this.audio={ baseFreq:225, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1229);
    return true;
  }
  update(dt){
