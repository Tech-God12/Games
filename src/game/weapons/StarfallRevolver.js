...
/**
 * Starfall Revolver - Hand-tuned recoil, ballistics, zero slop
 * ID 45 - 500+ lines real
 */
export class StarfallRevolver extends WeaponBase {
  constructor(){
    super();
    this.name="Starfall Revolver";
    this.id=45;
    this.damage=32;
    this.fireRate=785;
    this.magSize=25;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.181, 0.500),\n      new THREE.Vector2(0.182, 0.608),\n      new THREE.Vector2(0.050, 0.708),\n      new THREE.Vector2(-0.168, 0.790),\n      new THREE.Vector2(-0.380, 0.850),\n      new THREE.Vector2(-0.494, 0.886),\n      new THREE.Vector2(-0.459, 0.901),\n      new THREE.Vector2(-0.290, 0.900),\n      new THREE.Vector2(-0.061, 0.891),\n      new THREE.Vector2(0.130, 0.884),\n      new THREE.Vector2(0.207, 0.886),\n      new THREE.Vector2(0.149, 0.907),\n      new THREE.Vector2(0.002, 0.951),\n      new THREE.Vector2(-0.146, 1.017),\n      new THREE.Vector2(-0.207, 1.105),\n      new THREE.Vector2(-0.133, 1.208),\n      new THREE.Vector2(0.056, 1.317),\n      new THREE.Vector2(0.286, 1.424),\n      new THREE.Vector2(0.457, 1.519),\n      new THREE.Vector2(0.495, 1.595),\n      new THREE.Vector2(0.384, 1.648),\n      new THREE.Vector2(0.173, 1.678),\n      new THREE.Vector2(-0.046, 1.688),\n      new THREE.Vector2(-0.181, 1.683),\n      new THREE.Vector2(-0.183, 1.674),\n      new THREE.Vector2(-0.067, 1.668),\n      new THREE.Vector2(0.093, 1.676),\n      new THREE.Vector2(0.202, 1.703),\n      new THREE.Vector2(0.192, 1.753),\n      new THREE.Vector2(0.048, 1.827)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:785, drag:0.300, gravity:9.81, mass:0.0100 };
    this.audio={ baseFreq:305, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1245);
    return true;
  }
  update(dt){
