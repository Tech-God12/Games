/**
 * NEXUS VEIL - Weapon System: Oblivion Sniper
 * ID: WPN_0011
...
export class OblivionSniper extends WeaponBase {
  static WeaponName = "Oblivion Sniper";
  static WeaponId = 11;
  static Category = "DMR";
  static Rarity = "RARE";
  static BaseDamage = 107;
  static FireRate = 953;
  static MagazineSize = 20;
  static ReloadTime = 2.30;
  static EffectiveRange = 270;
  static Manufacturer = "VEIL DYNAMICS";

  constructor() {
    super();
    this.id = 11;
    this.name = "Oblivion Sniper";
    this.displayName = "OBLIVION SNIPER";
    this.category = OblivionSniper.constructor.Category || "DMR";
    this.damage = 107;
    this.fireRate = 953;
    this.magazineSize = 20;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 6;
    this.reloadTime = 2.30;
    this.effectiveRange = 270;
    this.accuracy = 0.810;
    this.mobility = 0.610;
    this.handling = 0.710;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(11);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.6, 0.5, -0.16085293413130297),
