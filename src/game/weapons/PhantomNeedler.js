/**
 * NEXUS VEIL - Weapon System: Phantom Needler
 * ID: WPN_0020
...
export class PhantomNeedler extends WeaponBase {
  static WeaponName = "Phantom Needler";
  static WeaponId = 20;
  static Category = "SNIPER";
  static Rarity = "COMMON";
  static BaseDamage = 90;
  static FireRate = 460;
  static MagazineSize = 15;
  static ReloadTime = 1.70;
  ...
  constructor() {
    super();
    this.id = 20;
    this.name = "Phantom Needler";
    this.displayName = "PHANTOM NEEDLER";
    this.category = PhantomNeedler.constructor.Category || "SNIPER";
    this.damage = 90;
    this.fireRate = 460;
    this.magazineSize = 15;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 3;
    this.reloadTime = 1.70;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(20);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.5, 0.5, 0.280970899936106),
