/**
 * NEXUS VEIL - Weapon System: Vortex LMG
 * ID: WPN_0016
...
export class VortexLMG extends WeaponBase {
  static WeaponName = "Vortex LMG";
  static WeaponId = 16;
  static Category = "ASSAULT_RIFLE";
  static Rarity = "RARE";
  static BaseDamage = 62;
  static FireRate = 768;
  static MagazineSize = 45;
  static ReloadTime = 1.30;
  static EffectiveRange = 370;
  static Manufacturer = "VEIL DYNAMICS";

  constructor() {
    super();
    this.id = 16;
    this.name = "Vortex LMG";
    this.displayName = "VORTEX LMG";
    this.category = VortexLMG.constructor.Category || "ASSAULT_RIFLE";
    this.damage = 62;
    this.fireRate = 768;
    this.magazineSize = 45;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 3;
    this.reloadTime = 1.30;
    this.effectiveRange = 370;
    this.accuracy = 0.860;
    this.mobility = 0.660;
    this.handling = 0.760;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(16);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.6, 0.4, -0.31367604835721785),
