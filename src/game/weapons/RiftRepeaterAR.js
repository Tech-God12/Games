/**
 * NEXUS VEIL - Weapon System: Rift-Repeater AR
 * ID: WPN_0008
...
export class RiftRepeaterAR extends WeaponBase {
  static WeaponName = "Rift-Repeater AR";
  static WeaponId = 8;
  static Category = "ASSAULT_RIFLE";
  static Rarity = "LEGENDARY";
  static BaseDamage = 86;
  static FireRate = 584;
  static MagazineSize = 55;
  static ReloadTime = 2.00;
  static EffectiveRange = 210;
  static Manufacturer = "AETHER FORGE";

  constructor() {
    super();
    this.id = 8;
    this.name = "Rift-Repeater AR";
    this.displayName = "RIFT-REPEATER AR";
    this.category = RiftRepeaterAR.constructor.Category || "ASSAULT_RIFLE";
    this.damage = 86;
    this.fireRate = 584;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(8);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.8, 0.5, -0.06644048390489354),
