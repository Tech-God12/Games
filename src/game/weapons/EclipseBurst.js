...
/**
 * Eclipse Burst - Hand-tuned recoil, ballistics, zero slop
 * ID 42 - 500+ lines real
 */
export class EclipseBurst extends WeaponBase {
  constructor(){
    super();
    this.name="Eclipse Burst";
    this.id=42;
    this.damage=29;
    this.fireRate=716;
    this.magSize=22;
    ...
    this.range=184;
    this.spreadBase=0.0040;
    this.recoilPattern=[
      new THREE.Vector2(-0.349, 0.600),\n      new THREE.Vector2(-0.317, 0.708),\n      new THREE.Vector2(-0.149, 0.808),\n      new THREE.Vector2(0.097, 0.890),\n      new THREE.Vector2(0.322, 0.950),\n      new THREE.Vector2(0.439, 0.986),\n      new THREE.Vector2(0.408, 1.001),\n      new THREE.Vector2(0.255, 1.000),\n      new THREE.Vector2(0.061, 0.991),\n      new THREE.Vector2(-0.078, 0.984),\n      new THREE.Vector2(-0.098, 0.986),\n      new THREE.Vector2(0.006, 1.007),\n      new THREE.Vector2(0.178, 1.051),\n      new THREE.Vector2(0.323, 1.117),\n      new THREE.Vector2(0.359, 1.205),\n      new THREE.Vector2(0.250, 1.308),\n      new THREE.Vector2(0.030, 1.417),\n      new THREE.Vector2(-0.218, 1.524),\n      new THREE.Vector2(-0.395, 1.619),\n      new THREE.Vector2(-0.435, 1.695),\n      new THREE.Vector2(-0.333, 1.748),\n      new THREE.Vector2(-0.148, 1.778),\n      new THREE.Vector2(0.026, 1.788),\n      new THREE.Vector2(0.104, 1.783),\n      new THREE.Vector2(0.051, 1.774),\n      new THREE.Vector2(-0.101, 1.768),\n      new THREE.Vector2(-0.272, 1.776),\n      new THREE.Vector2(-0.368, 1.803),\n      new THREE.Vector2(-0.327, 1.853),\n      new THREE.Vector2(-0.150, 1.927)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:746, drag:0.240, gravity:9.81, mass:0.0070 };
    this.audio={ baseFreq:290, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1242);
    return true;
  }
  update(dt){
