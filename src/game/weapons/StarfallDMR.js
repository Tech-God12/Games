/**
 * NEXUS VEIL - Weapon System: Starfall DMR
 * ID: WPN_0003
...
export class StarfallDMR extends WeaponBase {
  static WeaponName = "Starfall DMR";
  static WeaponId = 3;
  static Category = "DMR";
  static Rarity = "LEGENDARY";
  static BaseDamage = 51;
  static FireRate = 769;
  ...
  constructor() {
    super();
    this.id = 3;
    this.name = "Starfall DMR";
    this.displayName = "STARFALL DMR";
    this.category = StarfallDMR.constructor.Category || "DMR";
    this.damage = 51;
    this.fireRate = 769;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(3);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.8, 0.3, -0.342004583130916),
