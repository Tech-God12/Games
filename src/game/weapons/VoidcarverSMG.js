/**
 * NEXUS VEIL - Weapon System: Voidcarver SMG
 * ID: WPN_0001
...
export class VoidcarverSMG extends WeaponBase {
  static WeaponName = "Voidcarver SMG";
  static WeaponId = 1;
  static Category = "SMG";
  static Rarity = "RARE";
  static BaseDamage = 37;
  static FireRate = 523;
  ...
  constructor() {
    super();
    this.id = 1;
    this.name = "Voidcarver SMG";
    this.displayName = "VOIDCARVER SMG";
    this.category = VoidcarverSMG.constructor.Category || "SMG";
    this.damage = 37;
    this.fireRate = 523;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(1);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.6, 0.4, -0.12478623380646381),
