/**
 * NEXUS VEIL - Weapon System: NVX-Pulse Rifle
 * ID: WPN_0000
 * Type: Experimental Aetherium Ballistics
 * Manufacturer: KINETICA
 * 
...
export class NVXPulseRifle extends WeaponBase {
  static WeaponName = "NVX-Pulse Rifle";
  static WeaponId = 0;
  static Category = "ASSAULT_RIFLE";
  static Rarity = "COMMON";
  static BaseDamage = 30;
  static FireRate = 400;
  static MagazineSize = 15;
  static ReloadTime = 1.20;
  static EffectiveRange = 50;
  static Manufacturer = "KINETICA";

  constructor() {
    super();
    this.id = 0;
    this.name = "NVX-Pulse Rifle";
    this.displayName = "NVX-PULSE RIFLE";
    this.category = NVXPulseRifle.constructor.Category || "ASSAULT_RIFLE";
    this.damage = 30;
    this.fireRate = 400;
    this.magazineSize = 15;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 3;
    this.reloadTime = 1.20;
    this.effectiveRange = 50;
    this.accuracy = 0.700;
    this.mobility = 0.500;
    this.handling = 0.600;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.200,
      muzzleVelocity: 700,
      projectileMass: 0.0050,
      airDensity: 1.225
    });
    ...
    this.weaponSway = {
      amplitude: new THREE.Vector2(0.002, 0.003),
      frequency: new THREE.Vector2(0.8, 1.2),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(0);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.5, 0.3, 0.43198939100687195),
