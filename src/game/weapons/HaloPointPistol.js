/**
 * NEXUS VEIL - Weapon System: Halo Point Pistol
 * ID: WPN_0023
...
export class HaloPointPistol extends WeaponBase {
  static WeaponName = "Halo Point Pistol";
  static WeaponId = 23;
  static Category = "ENERGY";
  static Rarity = "LEGENDARY";
  static BaseDamage = 31;
  static FireRate = 829;
  static MagazineSize = 30;
  static ReloadTime = 2.00;
  static EffectiveRange = 110;
  static Manufacturer = "AETHER FORGE";

  constructor() {
    super();
    this.id = 23;
    this.name = "Halo Point Pistol";
    this.displayName = "HALO POINT PISTOL";
    this.category = HaloPointPistol.constructor.Category || "ENERGY";
    this.damage = 31;
    this.fireRate = 829;
    this.magazineSize = 30;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 6;
    this.reloadTime = 2.00;
    this.effectiveRange = 110;
    this.accuracy = 0.930;
    this.mobility = 0.730;
    this.handling = 0.830;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(23);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.8, 0.5, -0.03273840495591984),
