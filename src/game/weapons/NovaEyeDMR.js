/**
 * NEXUS VEIL - Weapon System: Nova-Eye DMR
 * ID: WPN_0015
...
export class NovaEyeDMR extends WeaponBase {
  static WeaponName = "Nova-Eye DMR";
  static WeaponId = 15;
  static Category = "ENERGY";
  static Rarity = "COMMON";
  static BaseDamage = 55;
  static FireRate = 645;
  static MagazineSize = 40;
  static ReloadTime = 1.20;
  static EffectiveRange = 350;
  static Manufacturer = "KINETICA";

  constructor() {
    super();
    this.id = 15;
    this.name = "Nova-Eye DMR";
    this.displayName = "NOVA-EYE DMR";
    this.category = NovaEyeDMR.constructor.Category || "ENERGY";
    this.damage = 55;
    this.fireRate = 645;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(15);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.5, 0.3, 0.2962400560933949),
