/**
 * NEXUS VEIL - Weapon System: Specter Carbine
 * ID: WPN_0021
...
export class SpecterCarbine extends WeaponBase {
  static WeaponName = "Specter Carbine";
  static WeaponId = 21;
  static Category = "LMG";
  static Rarity = "RARE";
  static BaseDamage = 97;
  static FireRate = 583;
  static MagazineSize = 20;
  static ReloadTime = 1.80;
  static EffectiveRange = 70;
  static Manufacturer = "VEIL DYNAMICS";

  constructor() {
    super();
    this.id = 21;
    this.name = "Specter Carbine";
    this.displayName = "SPECTER CARBINE";
    this.category = SpecterCarbine.constructor.Category || "LMG";
    this.damage = 97;
    this.fireRate = 583;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.220,
      muzzleVelocity: 1150,
      projectileMass: 0.0060,
      airDensity: 1.225
    });
    ...
    this.weaponSway = {
      ...
      frequency: new THREE.Vector2(0.9, 1.3),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(21);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.6, 0.3, -0.3895944021536937),
