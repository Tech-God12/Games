/**
 * NEXUS VEIL - Weapon System: Warden Shotgun
 * ID: WPN_0019
...
export class WardenShotgun extends WeaponBase {
  static WeaponName = "Warden Shotgun";
  static WeaponId = 19;
  static Category = "DMR";
  static Rarity = "MYTHIC";
  static BaseDamage = 83;
  static FireRate = 1137;
  static MagazineSize = 60;
  static ReloadTime = 1.60;
  static EffectiveRange = 430;
  static Manufacturer = "VOIDTECH";

  constructor() {
    super();
    this.id = 19;
    this.name = "Warden Shotgun";
    this.displayName = "WARDEN SHOTGUN";
    this.category = WardenShotgun.constructor.Category || "DMR";
    this.damage = 83;
    this.fireRate = 1137;
    this.magazineSize = 60;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 6;
    this.reloadTime = 1.60;
    this.effectiveRange = 430;
    this.accuracy = 0.890;
    this.mobility = 0.690;
    this.handling = 0.790;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(19);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.9, 0.4, -0.43502774261878696),
