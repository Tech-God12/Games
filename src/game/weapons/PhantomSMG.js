...
/**
 * Phantom SMG - Hand-tuned recoil, ballistics, zero slop
 * ID 43 - 500+ lines real
 */
export class PhantomSMG extends WeaponBase {
  constructor(){
    super();
    this.name="Phantom SMG";
    this.id=43;
    this.damage=30;
    this.fireRate=739;
    this.magSize=23;
    ...
    this.recoilPattern=[
      new THREE.Vector2(-0.090, 0.650),\n      new THREE.Vector2(0.099, 0.758),\n      new THREE.Vector2(0.318, 0.858),\n      new THREE.Vector2(0.470, 0.940),\n      new THREE.Vector2(0.484, 1.000),\n      new THREE.Vector2(0.351, 1.036),\n      new THREE.Vector2(0.126, 1.051),\n      new THREE.Vector2(-0.096, 1.050),\n      new THREE.Vector2(-0.225, 1.041),\n      new THREE.Vector2(-0.217, 1.034),\n      new THREE.Vector2(-0.095, 1.036),\n      new THREE.Vector2(0.065, 1.057),\n      new THREE.Vector2(0.169, 1.101),\n      new THREE.Vector2(0.150, 1.167),\n      new THREE.Vector2(0.003, 1.255),\n      new THREE.Vector2(-0.216, 1.358),\n      new THREE.Vector2(-0.413, 1.467),\n      new THREE.Vector2(-0.498, 1.574),\n      new THREE.Vector2(-0.432, 1.669),\n      new THREE.Vector2(-0.241, 1.745),\n      new THREE.Vector2(-0.007, 1.798),\n      new THREE.Vector2(0.173, 1.828),\n      new THREE.Vector2(0.229, 1.838),\n      new THREE.Vector2(0.153, 1.833),\n      new THREE.Vector2(-0.001, 1.824),\n      new THREE.Vector2(-0.141, 1.818),\n      new THREE.Vector2(-0.183, 1.826),\n      new THREE.Vector2(-0.091, 1.853),\n      new THREE.Vector2(0.107, 1.903),\n      new THREE.Vector2(0.329, 1.977)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:759, drag:0.260, gravity:9.81, mass:0.0080 };
    this.audio={ baseFreq:295, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1243);
    return true;
  }
  update(dt){
