/**
 * NEXUS VEIL - Weapon System: Sidewinder Pistol
 * ID: WPN_0006
...
export class SidewinderPistol extends WeaponBase {
  static WeaponName = "Sidewinder Pistol";
  static WeaponId = 6;
  static Category = "PISTOL";
  static Rarity = "RARE";
  static BaseDamage = 72;
  static FireRate = 1138;
  static MagazineSize = 45;
  static ReloadTime = 1.80;
  static EffectiveRange = 170;
  static Manufacturer = "VEIL DYNAMICS";

  constructor() {
    super();
    this.id = 6;
    this.name = "Sidewinder Pistol";
    this.displayName = "SIDEWINDER PISTOL";
    this.category = SidewinderPistol.constructor.Category || "PISTOL";
    this.damage = 72;
    this.fireRate = 1138;
    this.magazineSize = 45;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 5;
    this.reloadTime = 1.80;
    this.effectiveRange = 170;
    this.accuracy = 0.760;
    this.mobility = 0.560;
    this.handling = 0.660;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.320,
      muzzleVelocity: 1000,
      projectileMass: 0.0110,
      airDensity: 1.225
    });
    ...
    this.audioProfile = new WeaponAudioProfile({
      ...
      baseFrequency: 110,
      tailLength: 0.6,
      reverbMix: 0.30000000000000004
    });

    this.weaponSway = {
      amplitude: new THREE.Vector2(0.003, 0.004),
      frequency: new THREE.Vector2(1.4, 1.7999999999999998),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(6);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      flash: {
        ...
        color: new THREE.Color().setHSL(0.09, 0.8, 0.6),
        duration: 0.05
      },
      smoke: {
        count: 1,
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.6, 0.3, 0.47892105192211565),
