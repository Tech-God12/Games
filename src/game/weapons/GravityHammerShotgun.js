/**
 * NEXUS VEIL - Weapon System: Gravity Hammer Shotgun
 * ID: WPN_0009
...
export class GravityHammerShotgun extends WeaponBase {
  static WeaponName = "Gravity Hammer Shotgun";
  static WeaponId = 9;
  static Category = "SMG";
  static Rarity = "MYTHIC";
  static BaseDamage = 93;
  static FireRate = 707;
  static MagazineSize = 60;
  static ReloadTime = 2.10;
  static EffectiveRange = 230;
  static Manufacturer = "VOIDTECH";

  constructor() {
    super();
    this.id = 9;
    this.name = "Gravity Hammer Shotgun";
    this.displayName = "GRAVITY HAMMER SHOTGUN";
    this.category = GravityHammerShotgun.constructor.Category || "SMG";
    this.damage = 93;
    this.fireRate = 707;
    this.magazineSize = 60;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 4;
    this.reloadTime = 2.10;
    this.effectiveRange = 230;
    this.accuracy = 0.790;
    this.mobility = 0.590;
    this.handling = 0.690;
    ...
    this.weaponSway = {
      ...
      frequency: new THREE.Vector2(1.7000000000000002, 2.1),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(9);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.9, 0.3, -0.33400008991996155),
