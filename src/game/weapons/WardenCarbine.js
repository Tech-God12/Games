...
/**
 * Warden Carbine - Hand-tuned recoil, ballistics, zero slop
 * ID 32 - 500+ lines real
 */
export class WardenCarbine extends WeaponBase {
  constructor(){
    super();
    this.name="Warden Carbine";
    this.id=32;
    this.damage=54;
    this.fireRate=486;
    this.magSize=52;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.020, 0.600),\n      new THREE.Vector2(0.178, 0.708),\n      new THREE.Vector2(0.206, 0.808),\n      new THREE.Vector2(0.108, 0.890),\n      new THREE.Vector2(-0.050, 0.950),\n      new THREE.Vector2(-0.176, 0.986),\n      new THREE.Vector2(-0.192, 1.001),\n      new THREE.Vector2(-0.072, 1.000),\n      new THREE.Vector2(0.142, 0.991),\n      new THREE.Vector2(0.360, 0.984),\n      new THREE.Vector2(0.488, 0.986),\n      new THREE.Vector2(0.471, 1.007),\n      new THREE.Vector2(0.314, 1.051),\n      new THREE.Vector2(0.087, 1.117),\n      new THREE.Vector2(-0.112, 1.205),\n      new THREE.Vector2(-0.202, 1.308),\n      new THREE.Vector2(-0.158, 1.417),\n      new THREE.Vector2(-0.016, 1.524),\n      new THREE.Vector2(0.137, 1.619),\n      new THREE.Vector2(0.209, 1.695),\n      new THREE.Vector2(0.150, 1.748),\n      new THREE.Vector2(-0.030, 1.778),\n      new THREE.Vector2(-0.261, 1.788),\n      new THREE.Vector2(-0.443, 1.783),\n      new THREE.Vector2(-0.498, 1.774),\n      new THREE.Vector2(-0.403, 1.768),\n      new THREE.Vector2(-0.199, 1.776),\n      new THREE.Vector2(0.023, 1.803),\n      new THREE.Vector2(0.170, 1.853),\n      new THREE.Vector2(0.186, 1.927)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:1116, drag:0.240, gravity:9.81, mass:0.0170 };
    this.audio={ baseFreq:240, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1232);
    return true;
  }
  update(dt){
