...
/**
 * Ironclad Shotgun - Hand-tuned recoil, ballistics, zero slop
 * ID 48 - 500+ lines real
 */
export class IroncladShotgun extends WeaponBase {
  constructor(){
    super();
    this.name="Ironclad Shotgun";
    this.id=48;
    this.damage=35;
    this.fireRate=854;
    this.magSize=28;
    ...
    this.recoilPattern=[
      new THREE.Vector2(-0.049, 0.650),\n      new THREE.Vector2(-0.104, 0.758),\n      new THREE.Vector2(-0.029, 0.858),\n      new THREE.Vector2(0.144, 0.940),\n      new THREE.Vector2(0.329, 1.000),\n      new THREE.Vector2(0.434, 1.036),\n      new THREE.Vector2(0.397, 1.051),\n      new THREE.Vector2(0.222, 1.050),\n      new THREE.Vector2(-0.025, 1.041),\n      new THREE.Vector2(-0.247, 1.034),\n      new THREE.Vector2(-0.359, 1.036),\n      new THREE.Vector2(-0.326, 1.057),\n      new THREE.Vector2(-0.182, 1.101),\n      new THREE.Vector2(-0.010, 1.167),\n      new THREE.Vector2(0.097, 1.255),\n      new THREE.Vector2(0.080, 1.358),\n      new THREE.Vector2(-0.058, 1.467),\n      new THREE.Vector2(-0.251, 1.574),\n      new THREE.Vector2(-0.406, 1.669),\n      new THREE.Vector2(-0.440, 1.745),\n      new THREE.Vector2(-0.325, 1.798),\n      new THREE.Vector2(-0.101, 1.828),\n      new THREE.Vector2(0.145, 1.838),\n      new THREE.Vector2(0.315, 1.833),\n      new THREE.Vector2(0.350, 1.824),\n      new THREE.Vector2(0.251, 1.818),\n      new THREE.Vector2(0.081, 1.826),\n      new THREE.Vector2(-0.065, 1.853),\n      new THREE.Vector2(-0.107, 1.903),\n      new THREE.Vector2(-0.019, 1.977)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:824, drag:0.360, gravity:9.81, mass:0.0130 };
    this.audio={ baseFreq:320, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1248);
    return true;
  }
  update(dt){
