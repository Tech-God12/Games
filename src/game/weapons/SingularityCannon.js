/**
 * NEXUS VEIL - Weapon System: Singularity Cannon
 * ID: WPN_0013
 * Type: Experimental Aetherium Ballistics
 * Manufacturer: AETHER FORGE
 * 
...
export class SingularityCannon extends WeaponBase {
  static WeaponName = "Singularity Cannon";
  static WeaponId = 13;
  static Category = "LMG";
  static Rarity = "LEGENDARY";
  static BaseDamage = 41;
  static FireRate = 1199;
  static MagazineSize = 30;
  static ReloadTime = 2.50;
  static EffectiveRange = 310;
  static Manufacturer = "AETHER FORGE";

  constructor() {
    super();
    this.id = 13;
    this.name = "Singularity Cannon";
    this.displayName = "SINGULARITY CANNON";
    this.category = SingularityCannon.constructor.Category || "LMG";
    this.damage = 41;
    this.fireRate = 1199;
    this.magazineSize = 30;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 4;
    this.reloadTime = 2.50;
    this.effectiveRange = 310;
    this.accuracy = 0.830;
    this.mobility = 0.630;
    this.handling = 0.730;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.260,
      muzzleVelocity: 750,
      projectileMass: 0.0180,
      airDensity: 1.225
    });
    ...
    this.audioProfile = new WeaponAudioProfile({
      weaponId: 13,
      baseFrequency: 145,
      tailLength: 0.44999999999999996,
      reverbMix: 0.5
    });

    this.weaponSway = {
      amplitude: new THREE.Vector2(0.005, 0.006),
      frequency: new THREE.Vector2(1.1, 1.5),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(13);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.8, 0.4, -0.015221974277984218),
