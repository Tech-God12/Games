/**
 * NEXUS VEIL - Weapon System: Aether-Breaker Shotgun
 * ID: WPN_0002
...
export class AetherBreakerShotgun extends WeaponBase {
  static WeaponName = "Aether-Breaker Shotgun";
  static WeaponId = 2;
  static Category = "SHOTGUN";
  static Rarity = "EPIC";
  static BaseDamage = 44;
  static FireRate = 646;
  static MagazineSize = 25;
  static ReloadTime = 1.40;
  static EffectiveRange = 90;
  static Manufacturer = "NEXUS ARMS";

  constructor() {
    super();
    this.id = 2;
    this.name = "Aether-Breaker Shotgun";
    this.displayName = "AETHER-BREAKER SHOTGUN";
    this.category = AetherBreakerShotgun.constructor.Category || "SHOTGUN";
    this.damage = 44;
    this.fireRate = 646;
    this.magazineSize = 25;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 5;
    this.reloadTime = 1.40;
    this.effectiveRange = 90;
    this.accuracy = 0.720;
    this.mobility = 0.520;
    this.handling = 0.620;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.240,
      muzzleVelocity: 800,
      projectileMass: 0.0070,
      airDensity: 1.225
    });
    ...
    this.weaponSway = {
      ...
      frequency: new THREE.Vector2(1, 1.4),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(2);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.7, 0.5, -0.26630894007292993),
