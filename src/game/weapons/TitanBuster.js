/**
 * NEXUS VEIL - Weapon System: Titan Buster
 * ID: WPN_0022
...
export class TitanBuster extends WeaponBase {
  static WeaponName = "Titan Buster";
  static WeaponId = 22;
  static Category = "PISTOL";
  static Rarity = "EPIC";
  static BaseDamage = 104;
  static FireRate = 706;
  ...
  constructor() {
    super();
    this.id = 22;
    this.name = "Titan Buster";
    this.displayName = "TITAN BUSTER";
    this.category = TitanBuster.constructor.Category || "PISTOL";
    this.damage = 104;
    this.fireRate = 706;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(22);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.7, 0.4, -0.2640132313456398),
