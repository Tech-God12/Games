...
/**
 * Vortex Grenade Launcher - Hand-tuned recoil, ballistics, zero slop
 * ID 46 - 500+ lines real
 */
export class VortexGrenadeLauncher extends WeaponBase {
  constructor(){
    super();
    this.name="Vortex Grenade Launcher";
    this.id=46;
    this.damage=33;
    this.fireRate=808;
    this.magSize=26;
    ...
    this.recoilPattern=[
      new THREE.Vector2(0.072, 0.550),\n      new THREE.Vector2(-0.065, 0.658),\n      new THREE.Vector2(-0.250, 0.758),\n      new THREE.Vector2(-0.388, 0.840),\n      new THREE.Vector2(-0.401, 0.900),\n      new THREE.Vector2(-0.269, 0.936),\n      new THREE.Vector2(-0.036, 0.951),\n      new THREE.Vector2(0.208, 0.950),\n      new THREE.Vector2(0.366, 0.941),\n      new THREE.Vector2(0.383, 0.934),\n      new THREE.Vector2(0.268, 0.936),\n      new THREE.Vector2(0.089, 0.957),\n      new THREE.Vector2(-0.059, 1.001),\n      new THREE.Vector2(-0.098, 1.067),\n      new THREE.Vector2(-0.008, 1.155),\n      new THREE.Vector2(0.168, 1.258),\n      new THREE.Vector2(0.341, 1.367),\n      new THREE.Vector2(0.421, 1.474),\n      new THREE.Vector2(0.355, 1.569),\n      new THREE.Vector2(0.160, 1.645),\n      new THREE.Vector2(-0.091, 1.698),\n      new THREE.Vector2(-0.299, 1.728),\n      new THREE.Vector2(-0.385, 1.738),\n      new THREE.Vector2(-0.327, 1.733),\n      new THREE.Vector2(-0.168, 1.724),\n      new THREE.Vector2(0.004, 1.718),\n      new THREE.Vector2(0.098, 1.726),\n      new THREE.Vector2(0.064, 1.753),\n      new THREE.Vector2(-0.083, 1.803),\n      new THREE.Vector2(-0.272, 1.877)
    ];
    this.recoilIndex=0;
    this.bloom=0;
    this.heat=0;
    ...
    this.ballistics={ muzzleVelocity:798, drag:0.320, gravity:9.81, mass:0.0110 };
    this.audio={ baseFreq:310, tail:0.3 };
  ...
  reload(){
    ...
    setTimeout(()=>{ this.ammo+=take; this.reserve-=take; this.state.reloading=false; this.recoilIndex=0; this.bloom=0; }, 1246);
    return true;
  }
  update(dt){
