/**
 * NEXUS VEIL - Weapon System: Neon-Scythe SMG
 * ID: WPN_0010
...
export class NeonScytheSMG extends WeaponBase {
  static WeaponName = "Neon-Scythe SMG";
  static WeaponId = 10;
  static Category = "SHOTGUN";
  static Rarity = "COMMON";
  static BaseDamage = 100;
  static FireRate = 830;
  static MagazineSize = 15;
  static ReloadTime = 2.20;
  static EffectiveRange = 250;
  static Manufacturer = "KINETICA";

  constructor() {
    super();
    this.id = 10;
    this.name = "Neon-Scythe SMG";
    this.displayName = "NEON-SCYTHE SMG";
    this.category = NeonScytheSMG.constructor.Category || "SHOTGUN";
    this.damage = 100;
    this.fireRate = 830;
    this.magazineSize = 15;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 5;
    this.reloadTime = 2.20;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(10);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.5, 0.4, 0.4928689826702455),
