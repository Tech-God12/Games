/**
 * NEXUS VEIL - Weapon System: Quasar Burst Rifle
 * ID: WPN_0012
...
export class QuasarBurstRifle extends WeaponBase {
  static WeaponName = "Quasar Burst Rifle";
  static WeaponId = 12;
  static Category = "SNIPER";
  static Rarity = "EPIC";
  static BaseDamage = 34;
  static FireRate = 1076;
  static MagazineSize = 25;
  static ReloadTime = 2.40;
  static EffectiveRange = 290;
  static Manufacturer = "NEXUS ARMS";

  constructor() {
    super();
    this.id = 12;
    this.name = "Quasar Burst Rifle";
    this.displayName = "QUASAR BURST RIFLE";
    this.category = QuasarBurstRifle.constructor.Category || "SNIPER";
    this.damage = 34;
    this.fireRate = 1076;
    this.magazineSize = 25;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 3;
    this.reloadTime = 2.40;
    this.effectiveRange = 290;
    this.accuracy = 0.820;
    this.mobility = 0.620;
    this.handling = 0.720;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(12);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.7, 0.3, -0.05760141400091623),
