/**
 * NEXUS VEIL - Weapon System: Tempest LMG
 * ID: WPN_0005
...
export class TempestLMG extends WeaponBase {
  static WeaponName = "Tempest LMG";
  static WeaponId = 5;
  static Category = "LMG";
  static Rarity = "COMMON";
  static BaseDamage = 65;
  static FireRate = 1015;
  static MagazineSize = 40;
  static ReloadTime = 1.70;
  static EffectiveRange = 150;
  static Manufacturer = "KINETICA";

  constructor() {
    super();
    this.id = 5;
    this.name = "Tempest LMG";
    this.displayName = "TEMPEST LMG";
    this.category = TempestLMG.constructor.Category || "LMG";
    this.damage = 65;
    this.fireRate = 1015;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.300,
      muzzleVelocity: 950,
      projectileMass: 0.0100,
      airDensity: 1.225
    });
    ...
    this.weaponSway = {
      ...
      frequency: new THREE.Vector2(1.3, 1.7),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(5);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.5, 0.5, -0.20703760242731128),
