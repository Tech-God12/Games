/**
 * NEXUS VEIL - Weapon System: Event-Horizon Sniper
 * ID: WPN_0004
...
export class EventHorizonSniper extends WeaponBase {
  static WeaponName = "Event-Horizon Sniper";
  static WeaponId = 4;
  static Category = "SNIPER";
  static Rarity = "MYTHIC";
  static BaseDamage = 58;
  static FireRate = 892;
  static MagazineSize = 35;
  static ReloadTime = 1.60;
  static EffectiveRange = 130;
  static Manufacturer = "VOIDTECH";

  constructor() {
    super();
    this.id = 4;
    this.name = "Event-Horizon Sniper";
    this.displayName = "EVENT-HORIZON SNIPER";
    this.category = EventHorizonSniper.constructor.Category || "SNIPER";
    this.damage = 58;
    this.fireRate = 892;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(4);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.9, 0.4, 0.43386026379422593),
