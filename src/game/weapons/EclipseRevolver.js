/**
 * NEXUS VEIL - Weapon System: Eclipse Revolver
 * ID: WPN_0017
...
export class EclipseRevolver extends WeaponBase {
  static WeaponName = "Eclipse Revolver";
  static WeaponId = 17;
  static Category = "SMG";
  static Rarity = "EPIC";
  static BaseDamage = 69;
  static FireRate = 891;
  static MagazineSize = 50;
  static ReloadTime = 1.40;
  static EffectiveRange = 390;
  static Manufacturer = "NEXUS ARMS";

  constructor() {
    super();
    this.id = 17;
    this.name = "Eclipse Revolver";
    this.displayName = "ECLIPSE REVOLVER";
    this.category = EclipseRevolver.constructor.Category || "SMG";
    this.damage = 69;
    this.fireRate = 891;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(17);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.7, 0.5, -0.23312939944544442),
