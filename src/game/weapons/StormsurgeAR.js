/**
 * NEXUS VEIL - Weapon System: Stormsurge AR
 * ID: WPN_0024
...
export class StormsurgeAR extends WeaponBase {
  static WeaponName = "Stormsurge AR";
  static WeaponId = 24;
  static Category = "ASSAULT_RIFLE";
  static Rarity = "MYTHIC";
  static BaseDamage = 38;
  static FireRate = 952;
  ...
  constructor() {
    super();
    this.id = 24;
    this.name = "Stormsurge AR";
    this.displayName = "STORMSURGE AR";
    this.category = StormsurgeAR.constructor.Category || "ASSAULT_RIFLE";
    this.damage = 38;
    this.fireRate = 952;
    ...
    this.proceduralAnimations = this.generateProceduralAnimations(24);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.9, 0.3, 0.20906904510258628),
