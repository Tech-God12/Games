/**
 * NEXUS VEIL - Weapon System: Ion-Storm Rifle
 * ID: WPN_0018
...
export class IonStormRifle extends WeaponBase {
  static WeaponName = "Ion-Storm Rifle";
  static WeaponId = 18;
  static Category = "SHOTGUN";
  static Rarity = "LEGENDARY";
  static BaseDamage = 76;
  static FireRate = 1014;
  static MagazineSize = 55;
  static ReloadTime = 1.50;
  static EffectiveRange = 410;
  static Manufacturer = "AETHER FORGE";

  constructor() {
    super();
    this.id = 18;
    this.name = "Ion-Storm Rifle";
    this.displayName = "ION-STORM RIFLE";
    this.category = IonStormRifle.constructor.Category || "SHOTGUN";
    this.damage = 76;
    this.fireRate = 1014;
    this.magazineSize = 55;
    this.currentAmmo = this.magazineSize;
    this.reserveAmmo = this.magazineSize * 5;
    this.reloadTime = 1.50;
    this.effectiveRange = 410;
    this.accuracy = 0.880;
    this.mobility = 0.680;
    this.handling = 0.780;
    ...
    this.ballistics = new BallisticsSimulator({
      gravity: 9.81,
      dragCoefficient: 0.360,
      muzzleVelocity: 1000,
      projectileMass: 0.0230,
      airDensity: 1.225
    });
    ...
    this.weaponSway = {
      ...
      frequency: new THREE.Vector2(1.6, 2),
      phase: Math.random() * Math.PI * 2,
      adsMultiplier: 0.3
    };

    this.proceduralAnimations = this.generateProceduralAnimations(18);
  ...
  generateMuzzleEffects(origin, direction) {
    return {
      ...
      shell: {
        ...
        velocity: new THREE.Vector3(0.8, 0.3, 0.039077346359647214),
