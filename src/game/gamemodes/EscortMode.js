...
export class EscortMode {
  constructor(world){
    this.world=world; this.name='Escort'; this.state='WAITING'; this.timer=0; this.maxPlayers=27;
    this.teams=[]; this.objectives=[]; this.leaderboard=[]; this.events=[];
    this.settings={ circleSpeed:1.1177491860516222, lootMultiplier:1.9532348459709323, stormDamage:3.9761766574403596 };
  }
  init(){
    this.state='STARTING'; this.timer=0;
    this.generateObjectives(3);
  }
  ...
  updateObjective(obj, delta){
    // Escort specific objective logic
