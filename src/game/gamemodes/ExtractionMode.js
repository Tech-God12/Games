...
export class ExtractionMode {
  constructor(world){
    this.world=world; this.name='Extraction'; this.state='WAITING'; this.timer=0; this.maxPlayers=24;
    this.teams=[]; this.objectives=[]; this.leaderboard=[]; this.events=[];
    this.settings={ circleSpeed:1.474740892860518, lootMultiplier:1.5322027751201444, stormDamage:4.565837661739173 };
  }
  init(){
  ...
  updateObjective(obj, delta){
    // Extraction specific objective logic
