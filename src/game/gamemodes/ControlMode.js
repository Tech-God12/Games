...
export class ControlMode {
  constructor(world){
    this.world=world; this.name='Control'; this.state='WAITING'; this.timer=0; this.maxPlayers=29;
    this.teams=[]; this.objectives=[]; this.leaderboard=[]; this.events=[];
    this.settings={ circleSpeed:1.4354686545711546, lootMultiplier:1.4642356267240493, stormDamage:3.4741640239518015 };
  }
  init(){
    this.state='STARTING'; this.timer=0;
    this.generateObjectives(4);
  }
  ...
  updateObjective(obj, delta){
    // Control specific objective logic
