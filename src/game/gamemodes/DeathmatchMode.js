...
export class DeathmatchMode {
  constructor(world){
    this.world=world; this.name='Deathmatch'; this.state='WAITING'; this.timer=0; this.maxPlayers=30;
    this.teams=[]; this.objectives=[]; this.leaderboard=[]; this.events=[];
    this.settings={ circleSpeed:0.7657383011731984, lootMultiplier:1.5116624779354564, stormDamage:3.4898320913937617 };
  }
  init(){
  ...
  updateObjective(obj, delta){
    // Deathmatch specific objective logic
