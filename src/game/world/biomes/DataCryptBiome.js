...
export class DataCryptBiome {
  constructor(seed=7771){
    this.name='DataCrypt'; this.seed=seed; this.temperature=23.0; this.humidity=0.69; this.radiation=0.84;
    this.structures=[]; this.lootMultiplier=1.20; this.enemyDensity=0.28;
    this.colors={ primary:new THREE.Color().setHSL(0.815,0.8,0.5), secondary:new THREE.Color().setHSL(0.628,0.6,0.3), fog:new THREE.Color().setHSL(0.010,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=23;
  ...
  getFogDensity(){ return 0.00526; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.37 }; }
