...
export class PlasmaSeaBiome {
  constructor(seed=9208){
    this.name='PlasmaSea'; this.seed=seed; this.temperature=63.9; this.humidity=0.93; this.radiation=0.58;
    this.structures=[]; this.lootMultiplier=1.09; this.enemyDensity=0.76;
    this.colors={ primary:new THREE.Color().setHSL(0.062,0.8,0.5), secondary:new THREE.Color().setHSL(0.020,0.6,0.3), fog:new THREE.Color().setHSL(0.794,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=30;
  ...
  getFogDensity(){ return 0.00304; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.69 }; }
