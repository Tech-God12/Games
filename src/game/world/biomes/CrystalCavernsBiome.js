...
export class CrystalCavernsBiome {
  constructor(seed=9433){
    this.name='CrystalCaverns'; this.seed=seed; this.temperature=29.7; this.humidity=0.73; this.radiation=0.87;
    this.structures=[]; this.lootMultiplier=0.88; this.enemyDensity=0.52;
    this.colors={ primary:new THREE.Color().setHSL(0.784,0.8,0.5), secondary:new THREE.Color().setHSL(0.640,0.6,0.3), fog:new THREE.Color().setHSL(0.025,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=28;
  ...
  getFogDensity(){ return 0.00574; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.85 }; }
