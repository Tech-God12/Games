...
export class ForgeDistrictBiome {
  constructor(seed=4639){
    this.name='ForgeDistrict'; this.seed=seed; this.temperature=21.8; this.humidity=0.02; this.radiation=0.26;
    this.structures=[]; this.lootMultiplier=1.07; this.enemyDensity=0.23;
    this.colors={ primary:new THREE.Color().setHSL(0.836,0.8,0.5), secondary:new THREE.Color().setHSL(0.520,0.6,0.3), fog:new THREE.Color().setHSL(0.681,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=41;
  ...
  getFogDensity(){ return 0.00582; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.42 }; }
