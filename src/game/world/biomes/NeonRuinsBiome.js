...
export class NeonRuinsBiome {
  constructor(seed=9637){
    this.name='NeonRuins'; this.seed=seed; this.temperature=34.0; this.humidity=0.38; this.radiation=0.88;
    this.structures=[]; this.lootMultiplier=0.92; this.enemyDensity=0.38;
    this.colors={ primary:new THREE.Color().setHSL(0.152,0.8,0.5), secondary:new THREE.Color().setHSL(0.009,0.6,0.3), fog:new THREE.Color().setHSL(0.752,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=43;
  ...
  getFogDensity(){ return 0.00225; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.66 }; }
