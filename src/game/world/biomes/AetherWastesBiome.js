...
export class AetherWastesBiome {
  constructor(seed=9916){
    this.name='AetherWastes'; this.seed=seed; this.temperature=19.5; this.humidity=0.10; this.radiation=0.75;
    this.structures=[]; this.lootMultiplier=0.91; this.enemyDensity=0.67;
    this.colors={ primary:new THREE.Color().setHSL(0.633,0.8,0.5), secondary:new THREE.Color().setHSL(0.294,0.6,0.3), fog:new THREE.Color().setHSL(0.029,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=23;
