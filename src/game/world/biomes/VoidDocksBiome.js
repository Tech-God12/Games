...
export class VoidDocksBiome {
  constructor(seed=5083){
    this.name='VoidDocks'; this.seed=seed; this.temperature=-6.7; this.humidity=0.76; this.radiation=0.06;
    this.structures=[]; this.lootMultiplier=1.24; this.enemyDensity=0.63;
    this.colors={ primary:new THREE.Color().setHSL(0.834,0.8,0.5), secondary:new THREE.Color().setHSL(0.214,0.6,0.3), fog:new THREE.Color().setHSL(0.052,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=25;
  ...
  getFogDensity(){ return 0.00231; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.33 }; }
