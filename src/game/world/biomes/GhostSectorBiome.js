...
export class GhostSectorBiome {
  constructor(seed=4882){
    this.name='GhostSector'; this.seed=seed; this.temperature=68.9; this.humidity=0.38; this.radiation=0.85;
    this.structures=[]; this.lootMultiplier=1.36; this.enemyDensity=0.59;
    this.colors={ primary:new THREE.Color().setHSL(0.586,0.8,0.5), secondary:new THREE.Color().setHSL(0.178,0.6,0.3), fog:new THREE.Color().setHSL(0.018,0.4,0.2) };
    this.generate();
  }
  generate(){
    const count=47;
  ...
  getFogDensity(){ return 0.00159; }
  getAmbientLight(){ return { color:this.colors.secondary.clone(), intensity:0.53 }; }
